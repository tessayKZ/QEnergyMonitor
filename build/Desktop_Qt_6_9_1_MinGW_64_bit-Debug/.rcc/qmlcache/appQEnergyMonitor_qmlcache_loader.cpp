...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appQEnergyMonitor)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appQEnergyMonitor))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appQEnergyMonitor)() {
    return 1;
}
